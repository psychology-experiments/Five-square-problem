...
const controls_training = ``;
const probe_training = `
Отлично!\n
...
Постарайтесь выполнять задание как можно быстрее и точнее\n
Если Вы готовы, нажмите ПРОБЕЛ`;
const inhibition_probe_short = `
Если слово окрашено в КРАСНЫЙ или ЖЕЛТЫЙ цвет, нажимайте стрелку ВПРАВО\n
Если слово окрашено в ЗЕЛЕНЫЙ или СИНИЙ цвет, нажимайте стрелку ВЛЕВО\n`;
const updating_probe_full = `
...
const rawInstructions = {
    ...
    probe_training,
    shifting_probe_full,
    shifting_probe_short,
    inhibition_probe_full,
    inhibition_probe_short,
    updating_probe_full,
    updating_probe_short,
};

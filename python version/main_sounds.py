...
second_instruction = "Отлично! Теперь Вам необходимо решить задачу! Перед Вами 5 квадратов, " \
                     ...
                     "Если Вы ощущаете, что не знаете как решать, у Вас нет идей, или Вы исчерпали все варианты решения, нажмите клавишу Я ЗАСТРЯЛ. Для продолжения нажмите ПРОБЕЛ"
...
if experiment_info["Группа"] == "1":
    experiment_info["feedback.type"] = "positive"
else:
    experiment_info["feedback.type"] = "negative"
